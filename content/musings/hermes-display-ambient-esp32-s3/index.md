...
redirect_to: /musings/cerebro-ambient-ai-display/
sitemap: false
---
...
For Hermes: add to config.yaml under mcp_servers with stdio transport pointing to hermes-display-mcp.
For Claude Code: claude mcp add hermes-display -- hermes-display-mcp

## References
1. [Original plan — Codex implementation brief](https://github.com/bagdeabhishek/hermes-display) — community
