...
- open-ended structure (infinite rooms).
This let creators add stories, maps, entities, and game systems without needing a central owner. ([R1], [R4])
...
- adaptation-specific continuity (for example, Kane Pixels’ universe).
So fragmentation is a feature of participatory fiction, not merely community conflict. ([R1], [R4])
...
- ![The iconic Backrooms image (HobbyTown Oshkosh interior under construction)](https://commons.wikimedia.org/wiki/Special:FilePath/HobbyTown_USA_Oshkosh_interior_under_construction_2002_(The_Backrooms).jpg)
  - Source: [Wikimedia Commons file record](https://commons.wikimedia.org/wiki/File:HobbyTown_USA_Oshkosh_interior_under_construction_2002_(The_Backrooms).jpg)
